...
| Item | Status | Notes |
|---|---|---|
| pytest suite for backend | ✅ | 121 tests (was 112) — added template upload round-trip + `pack_generator.render_docx` template-pickup behaviour (9 tests). ~2.0s. |
