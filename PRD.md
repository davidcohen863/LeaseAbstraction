...
| Item | Status | Notes |
|---|---|---|
| pytest suite for backend | ✅ | 135 tests (was 121) — added DELETE/PATCH endpoint coverage with cascade math + property-survives-lease-delete + comparables-FK-null + settled-pack refusal + audit-log-on-rename (14 tests). ~2.5s. |
