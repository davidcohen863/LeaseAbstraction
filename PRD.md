...
| Item | Status | Notes |
|---|---|---|
| pytest suite for backend | ✅ | 149 tests (was 141) — added health-endpoint coverage (liveness, readiness with 4-check breakdown, anthropic-key down vs degraded, storage probe doesn't leak). ~3.1s. |
