...
| Item | Status | Notes |
|---|---|---|
| pytest suite for backend | ✅ | 112 tests (was 98) — added Use Classes Order extraction matrix for `settle_pack` (11 real-world clause variants + edge cases). ~1.7s. |
