...
| Item | Status | Notes |
|---|---|---|
| pytest suite for backend | ✅ | 151 tests (was 149) — added rate-limit coverage (limit fires at 11th call, disabled-fixture sanity check). ~3.2s. |
