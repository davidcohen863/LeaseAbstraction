...
| Item | Status | Notes |
|---|---|---|
| pytest suite for backend | ✅ | 155 tests (was 151) — added Idempotency-Key coverage (no-header pass-through, same-key replay, conflicting-body 409, key-sanitisation). ~3.4s. |
